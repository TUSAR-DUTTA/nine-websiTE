...
const ALL_ENRICHMENTS = [
  ...
  {
    handle: 'KeithDiamondPaws',
    displayName: 'Diamond Whiskers',
    avatarUrl: '/assets/mascot/mascot_head_favicon.webp',
    title: '⚡ #1 TIMELINE BAG WORKER',
    quote: '"I like the cat. $nine is retail power incarnate. Working the bag every single day on Robinhood Chain."',
    achievements: ['#1 POST VOLUME', 'DIAMOND PAWS', 'CONVICTION HOLDER'],
    postsCount: 14,
    topPostImpressions: 28400,
    score: 93.8,
  },
  {
    handle: 'GME_Retail_Echo',
    displayName: 'Retail Rebellion',
    avatarUrl: '/assets/mascot/mascot_head_favicon.webp',
    title: '🎯 MEME VANGUARD',
    quote: '"They shut off the buy button in 2021. Nine the cat never forgets. $nine is our comeback story."',
    achievements: ['GME VETERAN', 'BAG WORKER', 'TIMELINE SUPPORTER'],
    postsCount: 9,
    topPostImpressions: 19200,
    score: 88.2,
  },
  {
    handle: 'WhaleWatchRH',
    displayName: 'Robinhood Whale Telemetry',
    avatarUrl: '/assets/mascot/mascot_head_favicon.webp',
    title: '🐋 ON-CHAIN WHALE TRACKER',
    quote: '"Large accumulation alert: Wallet tracked loading $nine on Robinhood Chain Uniswap v4 pool."',
    achievements: ['WHALE RADAR', 'ON-CHAIN TELEMETRY', 'VOLUME TRACKER'],
    postsCount: 7,
    topPostImpressions: 14100,
    score: 84.5,
  },
  {
    handle: 'DexRadar_RH',
    displayName: 'DEX Screener Radar',
    avatarUrl: '/assets/mascot/mascot_head_favicon.webp',
    title: '📈 DEXSCREENER ALERT',
    quote: '"$nine trending in top Robinhood Chain pairs. Liquidity locked, Nine The Cat meta expanding."',
    achievements: ['DEX TELEMETRY', 'TRENDING RADAR', 'LIQUIDITY WATCH'],
    postsCount: 6,
    topPostImpressions: 11200,
    score: 81.0,
  },
];
